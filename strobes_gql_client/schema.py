...
class ActivityType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'action', 'data', 'user', 'team', 'bug', 'asset', 'connector_config', 'engagement', 'connector', 'credential_manager', 'task', 'approval', 'automation_workflow', 'automation_workflow_reason', 'created', 'updated', 'comment_set')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
...
class BugType(sgqlc.types.Type):
    ...
    target_info = sgqlc.types.Field(sgqlc.types.list_of(String), graphql_name='targetInfo')
...
class CredentialManagerType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'name', 'type', 'organization', 'extra', 'is_expired', 'fernet_key', 'created_by', 'config_count', 'created', 'updated', 'automationworkflows_set', 'activity_credential')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class EngagementType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'engagement_custom_id', 'name', 'organization', 'vendor', 'security_posture', 'scheduled_date', 'delivery_date', 'documents', 'subscribed_services', 'checked_terms_and_conditions', 'executive_summary', 'credits_estimated', 'credits', 'created_by', 'created', 'updated', 'is_active', 'plans', 'engagement_assessment', 'prerequisites_engagement', 'exportreport_set', 'bug_engagements', 'activity_engagement', 'comments_engagement', 'assessments_count', 'engagement_completion', 'assessments_per_service', 'total_hours_spent', 'prerequisites_completion', 'state')
...
class MemberType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'user', 'organization', 'role', 'asset_search_query', 'preset_set', 'approval_approved_by', 'approval_raised_by', 'dashboards_set', 'widget_set', 'is_active', 'engagements', 'assets')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    user = sgqlc.types.Field(ApprovalUserType, graphql_name='user')
    organization = sgqlc.types.Field(sgqlc.types.non_null('TenantOrganizationType'), graphql_name='organization')
...
class OrganizationMembersType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'user', 'organization', 'role', 'asset_search_query', 'preset_set', 'approval_approved_by', 'approval_raised_by', 'dashboards_set', 'widget_set', 'email')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    user = sgqlc.types.Field(ApprovalUserType, graphql_name='user')
    organization = sgqlc.types.Field(sgqlc.types.non_null('TenantOrganizationType'), graphql_name='organization')
    role = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='role')
...
class TrackersType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'config', 'url', 'issue_key', 'bug', 'organization', 'asset', 'patch', 'is_groupped_issues', 'grouped_by', 'last_log', 'created', 'updated')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    config = sgqlc.types.Field(ConfigurationsFieldType, graphql_name='config')
    url = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='url')
