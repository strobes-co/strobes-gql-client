...
########################################################################
class AgentDocumentIndexingStatus(sgqlc.types.Enum):
    __schema__ = schema
...
class PatchPatchType(sgqlc.types.Enum):
    __schema__ = schema
    __choices__ = ('A_1',)


class PortState(sgqlc.types.Enum):
    __schema__ = schema
...
class AgentDocumentType(sgqlc.types.Type):
    ...
    indexing_status = sgqlc.types.Field(sgqlc.types.non_null(AgentDocumentIndexingStatus), graphql_name='indexingStatus')
...
class ApprovalUserType(sgqlc.types.Type):
    ...
    chatsession_set = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('ChatSessionType'))), graphql_name='chatsessionSet')
...
class AutomationWorkflowType(sgqlc.types.Type):
    ...
    activity_set = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('EngagementActivityType'))), graphql_name='activitySet')
    comment_set = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('EngagementCommentType'))), graphql_name='commentSet')
    chat_sessions = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('ChatSessionType'))), graphql_name='chatSessions')
...
class CVEType(sgqlc.types.Type):
    ...
    trend = sgqlc.types.Field(sgqlc.types.non_null(CVETrend), graphql_name='trend')
    source = sgqlc.types.Field(sgqlc.types.non_null(CVESource), graphql_name='source')
    advisories_seen = sgqlc.types.Field(sgqlc.types.list_of(String), graphql_name='advisoriesSeen')
    epss_score = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name='epssScore')
    cisa_due_date = sgqlc.types.Field(Date, graphql_name='cisaDueDate')
    created = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='created')
...
class ChatMessageSubscriptionType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'content', 'sender_type', 'message_type', 'timestamp', 'session_id', 'metadata')
    id = sgqlc.types.Field(ID, graphql_name='id')
    content = sgqlc.types.Field(JSONString, graphql_name='content')
    sender_type = sgqlc.types.Field(Int, graphql_name='senderType')
    message_type = sgqlc.types.Field(Int, graphql_name='messageType')
    timestamp = sgqlc.types.Field(DateTime, graphql_name='timestamp')
    session_id = sgqlc.types.Field(UUID, graphql_name='sessionId')
    metadata = sgqlc.types.Field(JSONString, graphql_name='metadata')


class ChatMessageType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'session', 'sender_type', 'message_type', 'content', 'timestamp', 'metadata', 'raw_interaction_details')
    id = sgqlc.types.Field(sgqlc.types.non_null(UUID), graphql_name='id')
    session = sgqlc.types.Field(sgqlc.types.non_null('ChatSessionType'), graphql_name='session')
    sender_type = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='senderType')
    message_type = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='messageType')
    content = sgqlc.types.Field(sgqlc.types.non_null(JSONString), graphql_name='content')
    timestamp = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='timestamp')
    metadata = sgqlc.types.Field(JSONString, graphql_name='metadata')
    raw_interaction_details = sgqlc.types.Field(JSONString, graphql_name='rawInteractionDetails')


class ChatSessionType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'organization', 'user', 'agent', 'title', 'created_at', 'updated_at', 'archived', 'is_processing_message', 'context', 'messages')
    id = sgqlc.types.Field(sgqlc.types.non_null(UUID), graphql_name='id')
    organization = sgqlc.types.Field(sgqlc.types.non_null('TenantOrganizationType'), graphql_name='organization')
    user = sgqlc.types.Field(sgqlc.types.non_null(ApprovalUserType), graphql_name='user')
    agent = sgqlc.types.Field(sgqlc.types.non_null(AutomationWorkflowType), graphql_name='agent')
    title = sgqlc.types.Field(String, graphql_name='title')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    updated_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='updatedAt')
    archived = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='archived')
    is_processing_message = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isProcessingMessage')
    context = sgqlc.types.Field(JSONString, graphql_name='context')
    messages = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(ChatMessageType))), graphql_name='messages')
...
class CreateChatSession(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('chat_session',)
    chat_session = sgqlc.types.Field(ChatSessionType, graphql_name='chatSession')
...
class CredentialManagerDetailType(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    type = sgqlc.types.Field(sgqlc.types.non_null(CredentialManagerType), graphql_name='type')
    organization = sgqlc.types.Field('TenantOrganizationType', graphql_name='organization')
    extra = sgqlc.types.Field(JSONString, graphql_name='extra')
    is_expired = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isExpired')
...
class InitialSuggestionType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('text', 'query')
...
class Mutation(sgqlc.types.Type):
    ...
    create_chat_session = sgqlc.types.Field(CreateChatSession, graphql_name='createChatSession', args=sgqlc.types.ArgDict((
        ('agent_id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='agentId', default=None)),
        ('organization_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='organizationId', default=None)),
        ('title', sgqlc.types.Arg(String, graphql_name='title', default=None)),
))
    )
    send_chat_message = sgqlc.types.Field('SendChatMessage', graphql_name='sendChatMessage', args=sgqlc.types.ArgDict((
        ('content_text', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='contentText', default=None)),
        ('organization_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='organizationId', default=None)),
        ('session_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='sessionId', default=None)),
))
    )
...
class OnNewChatMessage(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('message',)
    message = sgqlc.types.Field(ChatMessageSubscriptionType, graphql_name='message')
...
class PatchesType(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    organization = sgqlc.types.Field(sgqlc.types.non_null('TenantOrganizationType'), graphql_name='organization')
    patch_type = sgqlc.types.Field(sgqlc.types.non_null(PatchPatchType), graphql_name='patchType')
    package_name = sgqlc.types.Field(String, graphql_name='packageName')
...
class PortType(sgqlc.types.Type):
    ...
    state = sgqlc.types.Field(sgqlc.types.non_null(PortState), graphql_name='state')
...
class Query(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('organization_members', 'all_apis', 'available_system_agents', 'chat_sessions', 'chat_session_messages', 'initial_suggestions', 'risk_playground_data', 'all_possible_duplicates', 'total_count', 'all_prefills', 'all_self_managed_service_categories', 'all_self_managed_services', 'all_workbooks', 'all_sheet_rows', 'all_sheets', 'list_drafts', 'all_engagements_fields', 'all_automation_worfklow_activities', 'all_automation_workflows', 'all_configurations', 'all_patches', 'all_azure_devops_repositories', 'all_package_asset_count', 'all_tickets', 'all_docker_registry_images', 'all_ecr_images', 'all_sla_rules', 'search_query_exist', 'weightage_exist', 'all_presets', 'all_data_retention_settings', 'all_grouped_bugs', 'all_grouped_assets', 'all_asm_settings', 'all_asset_fields', 'all_bug_fields', 'all_vault_attachments', 'all_widgets_v2', 'all_dashboards_v2', 'all_veracode_projects', 'all_logs', 'all_action_logs', 'all_prerequisites', 'all_software_packages', 'all_packages', 'all_bitbucket_repositories', 'all_github_repositories', 'all_black_duck_projects', 'all_engagements_comment_activities', 'all_attachments', 'all_assessments', 'all_custom_assessment_statuses', 'all_approvals', 'all_assigned_user_views', 'check_view_name', 'all_report_attachments', 'all_prioritization_rules', 'all_priority_rule_sets', 'all_bug_reports', 'download_report', 'preview_report', 'all_templates', 'list_github_branch_tags', 'list_github_branch_tree', 'default_templates', 'default_asset_summary_report_template', 'default_sast_summary_report_template', 'default_dast_summary_report_template', 'default_executive_summary_report_template', 'default_cloud_security_overview_report_template', 'default_network_security_overview_report_template', 'default_container_security_overview_report_template', 'template_name_exist', 'all_widgets', 'all_assets_bugs_count_widget', 'all_software_packages_assets_bugs_count_widget', 'all_dashboards', 'all_groups', 'get_current_tenant', 'all_engagements', 'all_engagement_activities', 'all_engagements_activities', 'all_engagement_assets', 'all_engagement_bugs', 'all_nist', 'all_owasp', 'all_cve', 'all_cwe', 'pentesters_involved', 'all_tests', 'engagement_compliance_count', 'all_assets', 'asset_relationships_for_asset', 'all_asset_relationships_in_org', 'asset', 'all_bugs', 'close_findings', 'revert_closed_findings')
    ...
    chat_sessions = sgqlc.types.Field(sgqlc.types.list_of(ChatSessionType), graphql_name='chatSessions', args=sgqlc.types.ArgDict((
        ('organization_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='organizationId', default=None)),
        ('agent_id', sgqlc.types.Arg(ID, graphql_name='agentId', default=None)),
))
    )
    chat_session_messages = sgqlc.types.Field(sgqlc.types.list_of(ChatMessageType), graphql_name='chatSessionMessages', args=sgqlc.types.ArgDict((
        ('session_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='sessionId', default=None)),
        ('organization_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='organizationId', default=None)),
))
    )
    initial_suggestions = sgqlc.types.Field(sgqlc.types.list_of(InitialSuggestionType), graphql_name='initialSuggestions', args=sgqlc.types.ArgDict((
        ('agent_id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='agentId', default=None)),
        ('organization_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='organizationId', default=None)),
))
    )
...
class ReportType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'export_id', 'user', 'report_type', 'scan', 'report_name', 'report_path', 'file', 'created', 'status', 'bug_ids', 'asset_ids', 'organization', 'engagement', 'template', 'exported_app', 'html_report', 'revised_from', 'original_report', 'self_revised_from', 'self_original_report', 'automationworkflows_set', 'has_password')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
...
class SendChatMessage(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('chat_message',)
    chat_message = sgqlc.types.Field(ChatMessageType, graphql_name='chatMessage')
...
class StartSystemAgentChat(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('session',)
    session = sgqlc.types.Field(ChatSessionType, graphql_name='session')


class Subscription(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('on_new_chat_message',)
    on_new_chat_message = sgqlc.types.Field(OnNewChatMessage, graphql_name='onNewChatMessage', args=sgqlc.types.ArgDict((
        ('session_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='sessionId', default=None)),
))
    )
...
class UserType(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('password', 'is_superuser', 'id', 'email', 'first_name', 'last_name', 'created', 'updated', 'is_superadmin', 'is_staff', 'is_active', 'activation_id', 'bio', 'profile_picture', 'cover_heading', 'linkedin_url', 'twitter_url', 'designation', 'phone_number', 'last_login', 'username', 'org_members', 'organizationmember_set', 'asset_set', 'group_set', 'created_priority_rule_sets', 'engagements_set', 'assessment_asset_assigned_to', 'vault_set', 'prerequisites_assigned_to', 'prerequisites_user', 'workbook_set', 'sheet_set', 'sheetrow_set', 'prefills_set', 'configurations_set', 'scanlog_set', 'exportreport_set', 'reportattachment_set', 'credentialmanager_set', 'bottask_set', 'automationworkflows_set', 'agentdocument_set', 'assigned_to', 'reported_by', 'attachment_set', 'activity_set', 'comment_set', 'filterviews_set', 'views_members', 'reporttemplates_set', 'draft_set', 'chatsession_set', 'dashboards_set', 'widget_set', 'created_asset_relationships')
    password = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='password')
    is_superuser = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isSuperuser')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    email = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='email')
